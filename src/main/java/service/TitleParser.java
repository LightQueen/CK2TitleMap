...
//    }
            ...
            while (!line.equals("\t}")) {
                ...
                */
                ...
                while (!line.equals("\t\t}")) {
                    ...
                    if(index > -1){
                        t.setDynasty(line.substring(index + indexStr.length()));
                    }


                    int index2 = line.indexOf("\tholder=");
                    if(index2 > -1){
                        t.setHolder(line.substring(index2 + "\tholder=".length()));
                    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            list.forEach(t -> printWriter.println(t.getName() + "," + t.getDynasty()));
            printWriter.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
